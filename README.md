...
- The READ and CLOCK of the Game Boy Camera are directly connected to the 3.3V input if the Pi Pico and this is evil, I know. If this is too annoying for you, use a [serious bus transciever]([httpBoy crash](https://www.ti.com/lit/ds/symlink/sn74lvc4245a.pdf).
